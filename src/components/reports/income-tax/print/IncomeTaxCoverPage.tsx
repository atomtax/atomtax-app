import { PRINT_TOKENS, a4PageStyle } from '@/components/reports/print/CorporateTaxPrintTokens'
...
export function IncomeTaxCoverPage({ client, reportYear }: Props) {
  return (
    <div className="page-container" style={a4PageStyle}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', paddingTop: '14mm', gap: '14mm' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
          {[
            { label: '귀속연도', value: `${reportYear}년도` },
