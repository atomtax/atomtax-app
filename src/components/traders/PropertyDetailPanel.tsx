      ...
      <div className="mb-4 pb-3 border-b border-gray-200">
        <div className="flex items-center justify-between gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-1 flex-nowrap">
            {/* 자료성 — 부동산 폴더 / 입력참고용 / 홈택스 입력 참고 (PR #128) */}
            <button
              type="button"
              ...
              className="px-2 py-1 bg-yellow-100 text-yellow-800 hover:bg-yellow-200 text-[11px] rounded flex items-center gap-1 whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              className="px-2 py-1 bg-blue-100 text-blue-700 hover:bg-blue-200 text-[11px] rounded flex items-center gap-1 whitespace-nowrap"
            >
              <FileSearch size={11} /> 입력참고용
            </button>
            {/* 홈택스 입력 참고 — 양도소득세 건은 숨김 (PR #127) */}
            {property.tax_category !== '양도소득세' && (
              <a
                href={`/traders/${property.client_id}/hometax-guide/${property.id}`}
                target="_blank"
                rel="noopener noreferrer"
                className="px-2 py-1 bg-indigo-100 text-indigo-700 hover:bg-indigo-200 text-[11px] rounded flex items-center gap-1 whitespace-nowrap"
                title="새 탭으로 홈택스 입력 참고 화면 열기 (읽기 전용, 자동 입력 X)"
              >
                <ExternalLink size={11} /> 홈택스 입력 참고
              </a>
            )}
            {/* 액션 — 세금계산 / 부가세 계산기 / 고객 보고서 / 삭제 */}
            <button
              type="button"
              ...
              className="px-2 py-1 bg-purple-600 text-white hover:bg-purple-700 text-[11px] rounded flex items-center gap-1 whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              className="px-2 py-1 bg-slate-100 text-slate-700 hover:bg-slate-200 border border-slate-300 text-[11px] rounded flex items-center gap-1 whitespace-nowrap"
            >
            ...
            <button
              ...
              className="px-2 py-1 bg-indigo-100 text-indigo-700 hover:bg-indigo-200 border border-indigo-300 text-[11px] rounded flex items-center gap-1 whitespace-nowrap"
            >
            ...
            <button
              ...
              disabled={isPending}
              className="px-2 py-1 bg-red-50 text-red-600 hover:bg-red-100 text-[11px] rounded flex items-center gap-1 whitespace-nowrap disabled:opacity-50"
            >
              <Trash2 size={11} /> 삭제
            </button>
          </div>
